...
First, please do a search in [open issues](https://github.com/sjova/vscode-sass-format/issues) to see if the issue or feature request has already been filed. Use this [query](https://github.com/sjova/vscode-sass-format/issues?q=is%3Aopen+is%3Aissue+label%3Afeature-request+sort%3Areactions-%2B1-desc) to search for the most popular feature requests.
